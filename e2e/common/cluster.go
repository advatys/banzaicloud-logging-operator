...
func WithCluster(t *testing.T, fn func(*testing.T, cluster.Cluster), opts ...cluster.Option) {
...
func GetTestCluster(clusterName string, opts ...cluster.Option) (cluster.Cluster, error) {
	...
	return c, errors.WrapIfWithDetails(err, "creating cluster with rest config", "cfg", restCfg)
}
