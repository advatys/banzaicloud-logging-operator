...
func LoggingOperator(t *testing.T, c client.Client, opts ...LoggingOperatorOption) {
	...
	reconciler := reconciler.NewGenericReconciler(c, options.Logger, reconciler.ReconcilerOpts{
		Scheme: c.Scheme(),
	})
	...
	require.Eventually(t, func() bool {
		...
		if err := c.List(context.Background(), &ps, client.MatchingLabels{
