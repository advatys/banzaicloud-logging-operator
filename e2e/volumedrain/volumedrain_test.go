...
func TestVolumeDrain_Downscale(t *testing.T) {
	common.WithCluster(t, func(t *testing.T, c cluster.Cluster) {
		ns := "testing-1"

		setup.LoggingOperator(t, c.GetClient(), setup.LoggingOperatorOptionFunc(func(options *setup.LoggingOperatorOptions) {
